...
class Delete_Regusr_Demo extends JFrame implements ActionListener
{
...
class Delete_Registration_User
{
public static void main(String []s)
{
//Delete_Regusr_Demo dr= new Delete_Regusr_Demo();
}
}
